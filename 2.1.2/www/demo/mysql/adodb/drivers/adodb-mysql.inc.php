...
class ADORecordSet_mysql extends ADORecordSet{	
	...
	function ADORecordSet_mysql($queryID, $locale='') {
	GLOBAL $ADODB_FETCH_MODE;
...
//				return strftime($this->fmtDate,strtotime($this->fields[$colname])); 
			} else { 
