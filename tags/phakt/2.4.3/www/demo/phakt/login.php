...
if (isset($HTTP_POST_VARS["username"])) {
  ...
  $KT_redirectLoginSuccess = "menu.php";
  ...
  $KT_rsUser=$phaktconn->Execute($KT_rsUser_Source) or DIE($phaktconn->ErrorMsg());
  if (!$KT_rsUser->EOF) {
...
<form ACTION="<?php echo $KT_LoginAction?>" name="form1" method="POST">
