...
/** 
 * @version V2.31 20 Aug 2002 (c) 2000-2002 John Lim (jlim@natsoft.com.my). All rights reserved.
 ...
 *
 * Updated by Interakt to provide locale support for PostgreSQL, MySQL, iBase, Oracle et MsSQL
...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	 ...
	 */
	$ADODB_vers = 'V2.31 20 Aug 2002 (c) 2000-2002 John Lim (jlim@natsoft.com.my). All rights reserved. Released BSD & LGPL.';
	 ...
	 */	  
	function Connect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "", $argLocale = "") {
		...
		if ($fn = $this->raiseErrorFn) {
			...
			$fn($this->databaseType,'CONNECT',$this->ErrorNo(),$err,$this->host,$this->database, $this->locale);
		} else 
			if ($this->_connect($this->host, $this->user, $this->password, $this->database, $this->locale)) return true;
	...
	*/
	...
	function &Execute($sql,$inputarr=false,$arg3=false) 
	{
		...
		$rs = new $rsclass($this->_queryID,$this->locale); // &new not supported by older PHP versions
