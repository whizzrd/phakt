...
if ((isset($HTTP_POST_VARS["MM_insert"])) && ($HTTP_POST_VARS["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO users_usr (username_usr, password_usr, level_usr) VALUES (%s, %s, %s)",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline"> 
      ...
      <td><input type="text" name="username_usr" value="" size="32"></td>
    </tr>
    <tr valign="baseline"> 
      <td nowrap align="right">Password_usr:</td>
      <td><input type="text" name="password_usr" value="" size="32"></td>
    </tr>
    <tr valign="baseline"> 
      <td nowrap align="right">Level_usr:</td>
      <td><input type="text" name="level_usr" value="" size="32"></td>
    </tr>
    <tr valign="baseline"> 
